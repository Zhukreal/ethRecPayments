...
contract TeamContracts is TeamsStorageController {
    ...
    address public winTeamAddress; // Authorized account for managing teams

    modifier winTeamOnly {require(msg.sender == winTeamAddress); _;} // allows only winTeamAddress to trigger fun
    ...
    function createTeam (address teamOwnerAccount) winTeamOnly public returns(uint) {
     ...
     */
    function addMember (uint teamId, address memberAccount, uint agreementMinutes, uint agreementValue, bool singleTermAgreement, uint contractId) winTeamOnly public {
    ...
    function removeMember (uint teamId, uint contractId) winTeamOnly public {
    ...
    function payout (uint teamId) public {
        ...
        // This is intended to restrict WinTeam or anyone else from triggering payout (and thus the contract extension) for
     ...
     */
    function upgrade (address newDeployedTeamContracts) winTeamOnly public {
