...
contract("WinTokensVestingTest", (accounts) => {
    ...
    beforeEach(async function () {
        ...
        // https://winteam-gg.atlassian.net/wiki/spaces/WIN/pages/469401604/BC+Win+tokens+vesting+SC
        stages = [
            {
        ...
        token = await Token.new("WinTeam Token", "DTT");
        vesting = await WinTokensVestingTest.new(token.address, withdrawAddress, vestingStartTimestamp);
